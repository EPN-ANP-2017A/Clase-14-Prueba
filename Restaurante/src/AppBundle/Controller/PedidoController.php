...
class PedidoController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $em = $this->getDoctrine()->getManager();
            $pedido->setFecha(new \DateTime('now', (new \DateTimeZone('America/Guayaquil'))));

	        $detallePedido = new DetallePedido();
	        $detallePedido->setPedido($pedido);
	        $detallePedido->setCantidad($form->get('cantidad')->getData());
	        $detallePedido->setPlato($form->get('plato')->getData());
    ...
    public function editAction(Request $request, Pedido $pedido)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
	        $detallePedido = new DetallePedido();
	        $detallePedido->setPedido($pedido);
	        $detallePedido->setCantidad($editForm->get('cantidad')->getData());
	        $detallePedido->setPlato($editForm->get('plato')->getData());
